...
// validaciones por separado de cada input, si todas las validaciones son correctas, seran true, y si todo el formulario es true, entonces se envia la informacion
form.onsubmit=(e)=>{
     e.preventDefault();
    validacionNames();
    validacionEmail();
